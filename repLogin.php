...
<?php 
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if(empty($emailErr) && empty($passwordErr)) {
      ...
      // Search in Representative table for email matching email from form.
      // If found email
  ...
  <main>
    <div class="container">
      ...
      <div class="row">
        <div class="col-12">
          <h2 class="center">Representative Login</h2>
        </div>
      </div>
